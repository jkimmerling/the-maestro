...
- Pending: add explicit timeouts and structured request logging after confirming project-wide preferences (telemetry vs. built-in logging, timeout budgets per provider). Will update checkboxes once finalized.
