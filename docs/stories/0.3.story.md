...
- [ ] **Task 3.1: API Key Authentication** (AC-1)
  - [ ] **MANDATORY: Create `lib/the_maestro/providers/openai/api_key.ex`**
    - [ ] **MANDATORY: Complete @spec declarations for API key functions:**
      ```elixir
      ...
      ```
    - [ ] **MANDATORY: API key validation and client creation**
      ```elixir
      ...
      ```
    - [ ] **MANDATORY: Bearer token authentication with organization headers**
...
- [ ] **Task 4.1: Dual-Mode Streaming Support** (AC-3)
  - [ ] **MANDATORY: Create `lib/the_maestro/providers/openai/streaming.ex`**
    - [ ] **MANDATORY: Complete @spec declarations for streaming functions:**
      ...
      ```
  - [ ] **MANDATORY: Dual endpoint streaming support**
      ```elixir
...
- [ ] **Task 4.3: ChatGPT Personal Flow – Request Parity with Working Script** (AC-3)
  - [ ] **MANDATORY: Headers (exact) for ChatGPT personal mode**
    - [ ] `Authorization: Bearer <access_token>`
    - [ ] `chatgpt-account-id: <id_from_id_token_claim>`
...
- [ ] **Task 4.4: Enterprise Flow – Request Parity with Codex** (AC-5)
  - [ ] **MANDATORY: Headers (enterprise mode)**
    - [ ] `Authorization: Bearer <sk_openai_api_key>`
    - [ ] `version: <app_version>` (e.g., `to_string(Application.spec(:the_maestro, :vsn))`)
...
- [ ] **Task 6.2: Dual-Mode Testing Validation** (AC-4)
  - [ ] **MANDATORY: Test both ChatGPT and Enterprise modes**
    - [ ] Manual testing with personal OpenAI account (ChatGPT mode)
  ...
  - [ ] **MANDATORY: Streaming validation across modes**
    - [ ] Validate streaming works for both ChatGPT backend and OpenAI API
