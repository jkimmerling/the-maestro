...
- [x] **Task 1.2: OpenAI Configuration Module** (AC-1)
...
- [x] **Task 2.4: Codex-Compatible Account Detection** (AC-2)
...
- [x] **Task 4.4: Enterprise Flow – Request Parity with Codex** (AC-5)
