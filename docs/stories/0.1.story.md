...
- [x] **Task 4.1: OAuth Provider Behavior** (AC-3)
  - [ ] **MANDATORY: Create `lib/the_maestro/providers/behaviors/oauth_provider.ex`** (covered by `lib/the_maestro/providers/behaviours/auth.ex` – OAuth-specific callbacks to be added in provider stories)
...
- [x] **Task 4.2: API Key Provider Behavior** (AC-3)
  - [ ] **MANDATORY: Create `lib/the_maestro/providers/behaviors/api_key_provider.ex`** (covered by `lib/the_maestro/providers/behaviours/auth.ex` – API key validation utilities will be added in Story 0.2)
