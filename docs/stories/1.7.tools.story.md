...
Phase 3 — Registry & Router
- [ ] Implement `TheMaestro.Tools.Registry` with tool metadata and parameter schemas.
- [ ] Implement `TheMaestro.Tools.Router.execute/3` with validators and dispatch.
- [ ] Implement each tool module (shell, fs, multi-file, web) per above.
