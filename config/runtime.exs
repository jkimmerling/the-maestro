...
#
#     PHX_SERVER=true bin/the_maestro start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :the_maestro, TheMaestroWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  # Skip Phoenix configuration for TUI mode (escript)
  unless is_escript do
    ...
    config :the_maestro, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :the_maestro, TheMaestro.Mailer,
