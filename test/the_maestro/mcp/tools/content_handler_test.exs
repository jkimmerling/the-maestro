    ...
    test "processes audio content" do
      content = [
        %{
          "type" => "audio",
          "data" =>
            "UklGRnoGAABXQVZFZm10IBAAAAABAAEAQB8AAEAfAAABAAgAZGF0YQoGAACBhYqFbF1fdJivrJBhNjVgodDbq2EcBj+a2/LDciUFLIHO8tiJNwgZaLvt559NEAxQp+PwtmMcBjiR1/LMeSwFJHfH8N2QQAoUXrTp66hVFApGn+DyvmwhBTOH0PK5dysKL4/C8M2QPQYUUqzk5KBlGA==",
          "mimeType" => "audio/wav"
        }
      ]
