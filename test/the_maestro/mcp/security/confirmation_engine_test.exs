defmodule TheMaestro.MCP.Security.ConfirmationEngineTest do
  ...
  describe "process_confirmation_choice/3" do
    ...
    test "always_allow_tool whitelists tool and allows execution" do
      ...
      result = ConfirmationEngine.process_confirmation_choice(request, :always_allow_tool, context)
    ...
    test "always_trust_server trusts server and allows execution" do
      ...
      result = ConfirmationEngine.process_confirmation_choice(request, :always_trust_server, context)
  ...
  describe "handle_headless_security/2" do
    ...
    test "respects auto_block_high_risk policy setting" do
      ...
      result1 = ConfirmationEngine.handle_headless_security(request, %{auto_block_high_risk: true})
      assert result1.decision == :deny
      
      # With auto_block_high_risk disabled
      result2 = ConfirmationEngine.handle_headless_security(request, %{auto_block_high_risk: false})
