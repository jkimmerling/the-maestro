defmodule TheMaestro.Providers.Anthropic.Models do
  ...
  defp detect_auth(session_name) do
    cond do
      is_map(SavedAuthentication.get_by_provider_and_name(:anthropic, :oauth, session_name)) -> {:ok, :oauth}
      is_map(SavedAuthentication.get_by_provider_and_name(:anthropic, :api_key, session_name)) -> {:ok, :api_key}
